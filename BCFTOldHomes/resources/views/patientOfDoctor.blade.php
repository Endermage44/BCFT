            ...
            <div class="box">
                ...
                <div class="searchBar">
                    <form class="p-3">
                        ...
                        {{-- THIS IS ONLY SUPPOSED TO POP UP WHEN THE DR. HAS AN APPOINTMENT ON THIS DAY
                            THE LOGIC FOR THIS WILL BE IMPLEMENTED LATER!! --}}
                        <button type="submit">New Prescription</button>
                    </form>
                </div>
                <p>Information For: Add Logic To Grab Patient Name Here</p>
            <div id="appointmentTables">
               <div id="pastAppointments">
                    <table class="styled-table">
                        ...
                        <tbody>
                            <tr>
                                {{-- Add logic here to pull doctors name --}}
                                <td>John Smith</td>
                                {{-- Add logic to either enter a date via input or automatically get the date from the appointment --}}
                                <th>12/3/2023</th>
                                {{-- this is a comment the doctor can fill in --}}
                                <td>Needs Normal Pills</td>
                                {{-- this is added in by the doctor --}}
                                <td>Xanax</td>
                                {{-- this is added in by the doctor --}}
                                <td>N/A</td>
                                {{-- this is added in by the doctor --}}
