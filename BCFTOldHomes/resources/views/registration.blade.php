<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="box">
                <h3>Register</h3>
                <form id="register" action={{ url('/api/registration')}} method="POST">
                    @csrf
                    <!-- Role -->
                    ...
                    <div id="patientFields">
                        ...
                        <input placeholder= "1234" type="text" name="familyCode" id="family_code">

                        <label for="emergency_contact">Emergency Contact:</label>
                        <input placeholder= "(111)-111-1111" type="text" name="emergencyContactID" id="emergency_contact">

                        <label class = "last" for ="relation_to_emergency_contact">Relation to Emergency Contact:</label>
                        <input placeholder= "Son" type="text" name="relation_to_emergency_contact" id="relation_to_emergency_contact">
                    </div>
